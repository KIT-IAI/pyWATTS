...
class TestMinErr(unittest.TestCase):
    ...
    def test_get_params(self):
        self.assertEqual(self.min_err.get_params(),
                         {'offset': 0})

    def test_set_params(self):
        self.min_err.set_params(offset=24)
        self.assertEqual(self.min_err.get_params(),
                         {'offset': 24})
    ...
    def test_transform_with_filter(self):
        ...
        expected_result = {"pred1: complete": 0}
    ...
    def test_transform(self):
        ...
        test_result = self.min_err.transform(file_manager=MagicMock(), y=test_data['testCol'], gt=test_data['testCol'],
                                             pred1=test_data['predictCol1'],
                                             pred2=test_data['predictCol2'])

        expected_result = {"gt: complete": 0.0, "pred1: complete": 0, "pred2: complete": 1}
    ...
    def test_transform_without_predictions(self):
        ...
        with pytest.raises(InputNotAvailable) as e_info:
            self.min_err.transform(file_manager=MagicMock(), y=test_data['testCol'])
    ...
    def test_save(self, cloudpickle_mock, open_mock):
        ...
        mae = MinErr(name="NAME", filter_method=filter_mock)
    ...
    def test_load(self, cloudpickle_mock, open_mock):
        ...
        mae = MinErr.load(load_information)
